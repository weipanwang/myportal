...
<body>
 ...
 <legend>登录</legend>
   ...
   <form action="http://localhost:8088/user/login" method="post">
   ...
   <img src="http://localhost:8088/user/verification" onclick="reset1"/>
<!--    <input type="hidden" name="backurl" value="http://localhost:8088/user/login"> -->
   ...
   <input type="reset" value="重置">
	...
	<!-- <script>
	function reset1() {
		var srcs = $("[name='captcha']").attr('src')
		$("[name='backurl']").attr('src','http://localhost:8088/user/verification?v='+new Date());
	}
	</script> -->
</body>
</html>